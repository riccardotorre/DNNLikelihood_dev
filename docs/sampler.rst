...
and we are interested in creating a new sampler with the same parameters, the argument :option:`input_file`. Each of these
...
with priority in the order :option:`likelihood_script_file`, :option:`likelihood`, and :option:`input_file`. 
Let us see the three options in code:
    ...
    - Initialization from :option:`input_file`
        ...
        with the same parameters by passing the :option:`input_file` input. In this case, again, the 
...
and :option:`input_file`. This time, each of these
...
one of these inputs is give, only one is used, with priority in the order :option:`input_file`, 
...
"""""""""
    ...
    .. option:: likelihood_script_file
        ...
        genetated by the :meth:`Likelihood.save_script <DNNLikelihood.Likelihood.save_script>` method. 
    ...
    .. option:: nsteps_required

        Final number of MCMC steps. When the object is initialized with the :option:`new_sampler` argument set to ``False``
        then, if :option:`nsteps_required` is larger than the number of steps available in the backend, it is saved in the 
    ...
    .. option:: input_file   
        ...
        It is used to set the :attr:`Likelihood.input_file <DNNLikelihood.Likelihood.input_file>` 
        attribute.
...
""""""""""
    ...
    .. py:attribute:: DNNLikelihood.Sampler.output_figures_base_file
    ...
    .. py:attribute:: DNNLikelihood.Sampler.nsteps_required

        Attribute corresponding to the input argument :option:`nsteps_required` and representing the
        final number of MCMC steps to run. 
        When the object is initialized with the :option:`new_sampler` argument set to ``False``
        then, if :option:`nsteps_required` is larger than :attr:`Sampler.nsteps_available <DNNLikelihood.Sampler.nsteps_available>`,
    ...
    .. py:attribute:: DNNLikelihood.Sampler.input_file   
    ...
    .. py:attribute:: DNNLikelihood.Sampler.input_json_file   
    ...
    .. py:attribute:: DNNLikelihood.Sampler.input_log_file   
    ...
    .. py:attribute:: DNNLikelihood.Sampler.backend_file
    ...
    .. py:attribute:: DNNLikelihood.Sampler.output_json_file
    ...
    .. py:attribute:: DNNLikelihood.Sampler.output_log_file
...
"""""""
    ...
    .. automethod:: DNNLikelihood.Sampler._Sampler__get_likelihood_script_file_from_input_file

    .. automethod:: DNNLikelihood.Sampler._Sampler__get_likelihood_script_file_from_likelihood

    .. automethod:: DNNLikelihood.Sampler._Sampler__get_input_file_from_likelihood_script_file

    .. automethod:: DNNLikelihood.Sampler._Sampler__get_input_file_from_likelihood

    .. automethod:: DNNLikelihood.Sampler._Sampler__init_likelihood

    .. automethod:: DNNLikelihood.Sampler._Sampler__load
    ...
    .. automethod:: DNNLikelihood.Sampler.save_log

    .. automethod:: DNNLikelihood.Sampler.save_json

    .. automethod:: DNNLikelihood.Sampler.save
