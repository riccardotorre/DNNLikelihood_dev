...
"""""""""
    ...
    .. py:attribute:: DNNLikelihood.Sampler.likelihood_script_file
            ...
            genetated with the ``Likelihood.save_likelihood_script`` method. The script file is loaded 
    ...
    .. py:attribute:: DNNLikelihood.Sampler.likelihood
            ...
            method uses it to generate a ``Likelihood.save_likelihood_script`` in the 
            ...
            ``Likelihood.save_likelihood_script`` will contain, in the name, the "_from_sampler" suffix.
...
"""""""""""""""""""""
    ...
    .. py:attribute:: DNNLikelihood.Sampler.output_files_base_path
    ...
    .. py:attribute:: DNNLikelihood.Sampler.figure_files_base_path
            ...
            It is set to ``Sampler.output_files_base_path+"_figure.h5"``.
