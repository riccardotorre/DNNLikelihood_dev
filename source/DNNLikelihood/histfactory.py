...
#    __slots__ = "workspace_folder"
    def __init__(self,
        ...
        - **Produces files**
            ...
            - :attr:`Histfactory.output_pickle_file <DNNLikelihood.Histfactory.output_pickle_file>` (only if :option:`input_file` is ``None``)
        """
    ...
    def __check_define_input_files(self):
        ...
        :attr:`Histfactory.input_pickle_file <DNNLikelihood.Histfactory.input_pickle_file>`, and
    ...
    def __check_define_output_files(self):
        ...
        :attr:`Histfactory.output_json_file <DNNLikelihood.Histfactory.output_json_file>`,
        :attr:`Histfactory.output_log_file <DNNLikelihood.Histfactory.output_log_file>`, and
        :attr:`Histfactory.output_pickle_file <DNNLikelihood.Histfactory.output_pickle_file>`
        depending on the value of the 
        :attr:`Histfactory.input_file <DNNLikelihood.Histfactory.input_file>` and
    ...
    def __load(self,verbose=None):
        ...
        :attr:`Histfactory.input_json_file <DNNLikelihood.Histfactory.input_json_file>`,
        :attr:`Histfactory.input_json_file <DNNLikelihood.Histfactory.input_log_file>`
        and :attr:`Histfactory.input_pickle_file <DNNLikelihood.Histfactory.input_pickle_file>`.
...
.. |ipywidgets_link| raw:: html
    ...
    def save_json(self, overwrite=False, verbose=None):
        ...
        :attr:`Histfactory.output_json_file <DNNLikelihood.Histfactory.output_json_file>`,
        :attr:`Histfactory.output_log_file <DNNLikelihood.Histfactory.output_log_file>`
        and :attr:`Histfactory.output_pickle_file <DNNLikelihood.Histfactory.output_pickle_file>`.
        See the :meth:`Histfactory.save <DNNLikelihood.Histfactory.save>` method documentation
        for the list of saved attributes.

        This method is called by the
        :meth:`Histfactory.save <DNNLikelihood.Histfactory.save>` method to save the entire object.
    ...
    def save(self, lik_numbers_list=None, overwrite=True, verbose=None):
        ...
        :meth:`Histfactory.save_json <DNNLikelihood.Histfactory.save_json>`, and
        :meth:`Histfactory.save_log <DNNLikelihood.Histfactory.save_log>` methods to save the entire object.
        ...
        self.save_pickle(overwrite=overwrite, lik_numbers_list=lik_numbers_list, verbose=verbose)
...
.. |pyhf_model_logpdf_link| raw:: html
    ...
    <a href="https://scikit-hep.org/pyhf/_generated/pyhf.pdf.Model.html?highlight=logpdf#pyhf.pdf.Model.logpdf"  target="_blank"> pyhf.Model.logpdf</a>
        ...
        self.log[timestamp] = {"action": "saved likelihood object", 
                               ...
                               "file names": [path.split(lik_obj.output_pickle_file)[-1], 
                                              path.split(lik_obj.output_json_file)[-1], 
